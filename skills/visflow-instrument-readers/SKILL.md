...
3. **One reader per batch**, each with the same topic prompt; ask for their **trajectory** (what they read, in what order, where they got lost, what they had to infer) and a report.
